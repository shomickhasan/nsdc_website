...
$(window).on("load", function () {
  ...
  var horizontalchartOptions = {
    ...
    title: {
      display: true,
      text: 'Division wise Number of Entrepreneur'
    }
  };

  // Chart Data
  var horizontalchartData = {
    labels: ["Barishal", "Chattogram", "Dhaka", "Khulna", "Rajshahi","Rangpur","Mymensingh","Sylhet"],
    datasets: [{
      label: "Number of Entrepreneur",
      data: [2478, 5267, 734, 784, 433, 756, 7654, 98],
      backgroundColor: themeColors,
      borderColor: "transparent"
    }]
  };
