            ...
            <form id="registrationForm" method="POST" action="{{ route('registration.store') }}"
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 section-gap">
                        ...
                        <input type="text" name="full_name_bn" class="form-control"
                            value="{{ old('full_name_bn') }}">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 section-gap">
                        ...
                        <input type="text" name="permanent_post_office" id="permanent_post_office"
                            class="form-control" value="{{ old('permanent_post_office') }}"
                ...
                <div class="row">
                    <div class="col-12 section-gap">
                        <div class="form-check">
                            ...
                            <label class="form-check-label text-dark" for="same_as_permanent">Same as Permanent
                                Address</label>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 section-gap">
                        ...
                        <input type="text" name="present_post_office" id="present_post_office"
                            class="form-control" value="{{ old('present_post_office') }}"
                            placeholder="Post Office Name - Code (e.g. Natore Sadar - 6400)">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 section-gap">
                        ...
                        <input type="text" name="highest_education_level" class="form-control"
                            value="{{ old('highest_education_level') }}">
                        <p class="error-text highest_education_level_error"></p>
                    </div>

                    <div class="col-md-6 section-gap">
                        <label class="form-label">Highest Education Institute Name</label>
                        <input type="text" name="highest_education_institute_name" class="form-control"
                            value="{{ old('highest_education_institute_name') }}">
                        <p class="error-text highest_education_institute_name_error"></p>
                    </div>

                    <div class="col-md-6 section-gap">
                        <label class="form-label">Highest Education Passing Year</label>
                        <input type="text" name="highest_education_passing_year" class="form-control"
                            value="{{ old('highest_education_passing_year') }}">
                    ...
                    <div class="col-md-6 section-gap">
                        ...
                        <div class="asset-check-wrap">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="tvet_certificate"
                                    value="Yes">
                    ...
                    <div class="col-md-6 section-gap">
                        ...
                        <div class="asset-check-wrap">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="ethnic_minority"
                                    value="Yes">
                                <label class="form-check-label text-dark">Yes</label>
                            </div>
                            <div class="form-check">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 section-gap">
                        ...
                        <input type="text" name="past_skill_training" class="form-control"
                            value="{{ old('past_skill_training') }}">
                        <p class="error-text past_skill_training_error"></p>
                    </div>

                    <div class="col-md-6 section-gap">
                        <label class="form-label">Employment status before training</label>
                        <input type="text" name="employment_status_before_training" class="form-control"
                            value="{{ old('employment_status_before_training') }}">
        ...
        $('#same_as_permanent').on('change', function() {
            if ($(this).is(':checked')) {
                ...
                setTimeout(function() {
                    ...
                    setTimeout(function() {
                        loadUpazilas(permanentDistrict, '#present_upazila_id',
                            permanentUpazila);
                    }, 300);
                }, 300);
