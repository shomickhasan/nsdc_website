...
@section('title', 'Add Gallery Content')
...
@section('main')
    <div class="row mb-2">
        <div class="col">
            <h4 class="py-3 mb-4 fs-5 d-inline">
                ...
                <span class="heading-color">Add Content</span>
            </h4>
        </div>
    ...
    <div class="card mb-4">
        <div class="card-header">
            <h5 class="mb-0">Add Gallery Content</h5>
        </div>
        <div class="card-body">
            <form method="POST" action="{{ route('gallery.store') }}" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <select name="type" id="galleryType" class="form-select @error('type') is-invalid @enderror">
                        <option value="picture" {{ old('type') === 'picture' ? 'selected' : '' }}>Pictures Gallery</option>
                        <option value="video" {{ old('type') === 'video' ? 'selected' : '' }}>Video Gallery</option>
                    </select>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="title" id="title" class="form-control @error('title') is-invalid @enderror" value="{{ old('title') }}" placeholder="Gallery title">
                ...
                <div class="mb-3 gallery-picture-field">
                    ...
                    <small class="text-muted">Recommended image size: 1200x800px. JPG, PNG, or WebP. Max 4MB.</small>
                ...
                <div class="mb-3 gallery-video-field">
                    ...
                    <input type="url" name="youtube_url" id="youtube_url" class="form-control @error('youtube_url') is-invalid @enderror" value="{{ old('youtube_url') }}" placeholder="https://www.youtube.com/watch?v=...">
                    <small class="text-muted">Only YouTube links are needed. The video will be embedded on the frontend.</small>
                ...
                <div class="mb-3">
                    ...
                    <div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="status" value="1" {{ old('status', '1') == '1' ? 'checked' : '' }}>
                ...
                <div class="mb-3 mt-4">
                    <button type="submit" class="btn btn-primary me-2">Save Content</button>
